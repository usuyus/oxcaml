...
let to_binary_string x =
  String.init 8 (fun i ->
    if Int8.(equal (logand x (shift_left (Int8.of_int 1) (8 - i - 1))) (Stdlib_stable.Int8.of_int 0))
    then '0'
    else '1')
...
let test1 () =
  ...
  let three = (Int8_u.of_int 3) in
  print_int8u "Test 1, three" three;

  let twice_three = three + (Int8_u.of_int 3) in
  print_int8u "Test 1, twice_three" twice_three;

  let thrice_three = (Int8_u.of_int 3) * three in
  ...
  let three_again = twice_three_again / (Int8_u.of_int 2) in
  print_int8u "Test 1, three_again" three_again;

  let three_again_unsigned = twice_three_again // (Int8_u.of_int 2) in
  ...
  let three_with_effort =
    ((Int8_u.of_int 3) + twice_three) * (Stdlib_stable.Int8_u.of_int 2) / (Stdlib_stable.Int8_u.of_int 6) in
  print_int8u "Test 1, three_with_effort" three_with_effort;

  let seven_rem_three = (Int8_u.of_int 7) % three in
  print_int8u "Test 1, seven_rem_three" seven_rem_three;

  let seven_rem_three_unsigned = (Int8_u.of_int 7) %% three in
  print_int8u "Test 1, seven_rem_three_unsigned" seven_rem_three_unsigned;

  let forty_two_logand_three = logand (Int8_u.of_int 42) three in
  print_int8u_bin "Test1, forty_two_logand_three (0b00101010 & 0b00000011)" forty_two_logand_three;

  let forty_two_logor_three = logor (Int8_u.of_int 42) three in
  print_int8u_bin "Test1, forty_two_logor_three (0b00101010 & 0b00000011)" forty_two_logor_three;

  let forty_two_logxor_three = logxor (Int8_u.of_int 42) three in
  ...
  let minus_five = (Int8_u.of_int (-5)) in
  print_int8u "Test 1, minus_five" minus_five;

  let twice_minus_five = minus_five + ((Int8_u.of_int (-5))) in
  print_int8u "Test 1, twice_minus_five" twice_minus_five;

  let thrice_minus_five = (Int8_u.of_int 3) * minus_five in
  ...
  let minus_five_again = twice_minus_five_again / (Int8_u.of_int 2) in
  print_int8u "Test 1, minus_five_again" minus_five_again;

  let minus_five_again_unsigned = twice_minus_five_again // (Int8_u.of_int 2) in
  ...
  let minus_five_with_effort =
    (((Int8_u.of_int ( -5 ))) + twice_minus_five) * (Stdlib_stable.Int8_u.of_int 2) / (Stdlib_stable.Int8_u.of_int 6) in
  print_int8u "Test 1, minus_five_with_effort" minus_five_with_effort;

  let seven_rem_minus_five = (Int8_u.of_int 7) % minus_five in
  print_int8u "Test 1, seven_rem_minus_five" seven_rem_minus_five;

  let seven_rem_minus_five_unsigned = (Int8_u.of_int 7) %% minus_five in
  print_int8u "Test 1, seven_rem_minus_five_unsigned" seven_rem_minus_five_unsigned;

  let forty_two_logand_minus_five = logand (Int8_u.of_int 42) minus_five in
  print_int8u_bin "Test1, forty_two_logand_minus_five (0b00101010 & 0b1...1011)" forty_two_logand_minus_five;

  let forty_two_logor_minus_five = logor (Int8_u.of_int 42) minus_five in
  print_int8u_bin "Test1, forty_two_logor_minus_five (0b00101010 & 0b1...1011)" forty_two_logor_minus_five;

  let forty_two_logxor_minus_five = logxor (Int8_u.of_int 42) minus_five in
...
let[@inline never] twice_on_three f =
  let pi = (Int8_u.of_int 3) in
  twice f pi

let times_four = twice Int8_u.(fun x -> x * (Int8_u.of_int 2))

let _ =
  let open Int8_u in
  print_int8u "Test 2, add three twice"
    (twice (fun x -> x + (Int8_u.of_int 3)) (Stdlib_stable.Int8_u.of_int 0));
  print_int8u "Test 2, add three four times"
    (twice (twice (fun x -> x + (Int8_u.of_int 3))) (Stdlib_stable.Int8_u.of_int 0));
  print_int8u "Test 2, increment three twice"
    (twice_on_three (fun x -> (Int8_u.of_int 1) + x));
  print_int8u "Test 2, increment three four times"
    (twice_on_three (twice (fun x -> (Int8_u.of_int 1) + x)));
  print_int8u "Test 2, two times four"
    (times_four (Int8_u.of_int 2));
  print_int8u "Test 2, three times sixteen"
    (twice_on_three times_four);
  print_int8u "Test 2, three times sixteen again"
    (compose times_four times_four (Int8_u.of_int 3));
  print_int8u "Test 2, three minus four"
    (let two = twice (fun x -> x + (Int8_u.of_int 1)) (Stdlib_stable.Int8_u.of_int 0) in
     let add_two = Int8_u.(+) two in
     let add_two_after = compose add_two in
     let minus_four = add_two_after (twice (fun x -> x - (Int8_u.of_int 3))) in
     minus_four (Int8_u.of_int 3))
...
let test3 () =
  ...
  let five_times_three = f3 5 (Int8_u.of_int 3) steps in
...
let[@inline never] test4 () =
  ...
  let[@inline never] go f =
    Int8_u.to_int8 (f (Int8_u.of_int 1) (Stdlib_stable.Int8_u.of_int 2))
  in
  ...
  let steps = Array.init 10 (fun _ -> (Int8.of_int 0)) in
  let f = Sys.opaque_identity (f3 5 (Int8_u.of_int 3)) in
  ...
  let six_times_three = f (Int8_u.of_int 3) steps in
...
let test5 () =
  let open Int8_u in
  let _ : unit =
    f5 (Int8_u.of_int 3) (Stdlib_stable.Int8_u.of_int 2)
...
let test6 () =
  ...
  print_int8u "Test 6, 3"
    (o#f6_m1 (Int8_u.of_int 30) (Stdlib_stable.Int8_u.of_int 20) (Stdlib_stable.Int8_u.of_int 3));

  (* 4 * 8 = 32 *)
  let o = (Sys.opaque_identity f6_2) (4,7) in
  let result = o#f6_m2 8 (Int8_u.of_int 4) (fun x -> x * (Stdlib_stable.Int8_u.of_int 2)) in
  print_int8u "Test 6, 32" result;

  (* (1 + 2 + 3 + (-2) + (-12) + 4) * (2 + (-1) + 10) = -44 *)
  let o = (Sys.opaque_identity f6_3) (1,2) 3 in
  let result =
    o#f6_m3 (-2) (Int8_u.of_int 2)
      (fun[@inline never] i m1 m2 n m3 ->
         (of_int8 (Int8.of_int (add3 i n))) * (m1 + m2 + m3))
      ((Int8_u.of_int (-1))) (-12,4) (Stdlib_stable.Int8_u.of_int 10)
  in
...
module M = struct
  ...
  let g () = if Sys.opaque_identity true then (Int8_u.of_int 32) else f ()
end
